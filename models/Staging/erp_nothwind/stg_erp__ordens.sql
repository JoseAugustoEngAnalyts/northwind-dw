with
    fonte_ordens as (
        select   
            ...
            ,cast (ship_address as string) as endereco_do_destinatario
            ,cast (ship_postal_code as string) as cep_do_destinatario
            ,cast (ship_city as string) as cidade_do_destinatario
            ,cast (ship_region as string) as regiao_do_destinatario
            ,cast (ship_country as string) as pais_do_destinatario
